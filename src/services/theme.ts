...
export const THEME_OPTIONS: ThemeConfig[] = [
  {
    id: 'basic',
    name: 'Basic Theme',
    vibe: 'Dark Gradient & Subtle Ambient Matrix',
    tagline: 'Clean, dark gradient with subtle patterns & textures',
    icon: '✨',
    primaryColor: '#06b6d4', // cyan-500
    secondaryColor: '#0d9488', // teal-600
    accentColor: '#38bdf8', // sky-400
    canvasBg: '#050811',
    canvasTint: 'linear-gradient(180deg, #030712 0%, #050811 280px, #030712 100%)',
    cardBg: '#090d16',
    cardBorder: 'rgba(255, 255, 255, 0.12)',
    optionBg: '#0c1220',
    optionHoverBg: '#131d31',
    optionSelectedBg: '#162844',
    optionBorder: '#1e293b',
    bgSubtle: '#0f172a',
    borderSubtle: 'rgba(255, 255, 255, 0.12)',
    taglineColor: '#94a3b8',
    heroGradient: 'linear-gradient(135deg, #06b6d4 0%, #0284c7 50%, #0f172a 100%)',
    heroBannerBg: 'linear-gradient(180deg, rgba(5, 8, 17, 0.5) 0%, rgba(5, 8, 17, 0.8) 55%, #050811 100%)',
    heroAtmosphereGlow: 'radial-gradient(ellipse at 40% 30%, rgba(6, 182, 212, 0.25) 0%, rgba(13, 148, 136, 0.15) 40%, transparent 70%)',
    vibeTextGradient: 'linear-gradient(135deg, #38bdf8 0%, #06b6d4 50%, #2dd4bf 100%)',
    heroBadgeBg: 'rgba(15, 23, 42, 0.85)',
    heroBadgeBorder: 'rgba(6, 182, 212, 0.35)',
    ...
    primaryBtnClass: 'bg-cyan-600 hover:bg-cyan-500 text-white shadow-cyan-600/30',
    secondaryBtnClass: 'bg-slate-800 text-slate-200 hover:bg-slate-700',
    textAccentClass: 'text-cyan-400',
    swatches: ['#06b6d4', '#0d9488', '#38bdf8', '#050811'],
    isDark: true,
    heroPhotoUrl: '/images/bg_basic_minimal.jpg',
    heroPhotoPosition: 'center center',
    heroPhotoTag: '✨ Dark Gradient Background • Subtle Pattern & Texture',
    heroFloatingPhotos: [
      { url: '/images/bg_basic_minimal.jpg', title: 'Dark Gradient', location: 'Subtle Matrix • HD' },
      { url: '/images/bg_basic_minimal.jpg', title: 'Ambient Texture', location: 'Cyan Glow • 24°C' }
    ],
    previewTrip: {
      title: 'Dark Minimal & Serene Escape',
      image: '/images/bg_basic_minimal.jpg',
      subtitle: '4 Days • 2 Travellers • Pure Travel',
      budget: '₹25,000 Budget',
      temp: '24°C ☀️',
      day1Title: 'Day 1 • Arrival & Evening City Lights',
      activity1: { time: '04:30 PM', title: 'Scenic Sunset Stroll', category: 'Relaxation', cost: '₹300' },
      activity2: { time: '07:30 PM', title: 'Cozy Ambient Lounge & Dinner', category: 'Food', cost: '₹1,000' }
    }
  },
  {
    id: 'beach',
