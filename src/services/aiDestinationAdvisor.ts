...
export function getGenericDynamicIntelligence(
  ...
  const modes: TravelModeViability[] = [
    ...
    },
    {
      ...
      icon: '🏍️',
      isRecommended: false,
      durationEstimate: 'Motorcycle tour',
      estimatedCostRange: 'Fuel & pitstops',
      suitabilityScore: 78,
      pros: 'Thrilling open-air ride across highways & scenic mountain passes.',
      cons: 'Physical endurance needed for long rides.',
      hasSwitchOrTransfer: false,
      desc: `Open-highway motorcycle expedition from ${startCity} to ${destination}`,
      tag: 'Biking Route',
      transitHoursOneWay: 9,
      transitDaysRoundTrip: 2,
      minRequiredDaysForMode: 2
    },
    {
